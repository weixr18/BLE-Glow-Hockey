...
/* DATA_OUT */
#define DATA_OUT_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define DATA_OUT_0_INBUF_ENABLED 0u
#define DATA_OUT_0_INIT_DRIVESTATE 1u
#define DATA_OUT_0_INIT_MUXSEL 0u
#define DATA_OUT_0_INPUT_SYNC 2u
#define DATA_OUT_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DATA_OUT_0_NUM 3u
#define DATA_OUT_0_PORT GPIO_PRT0
#define DATA_OUT_0_SLEWRATE CY_GPIO_SLEW_FAST
#define DATA_OUT_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define DATA_OUT_1_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define DATA_OUT_1_0_INBUF_ENABLED 0u
#define DATA_OUT_1_0_INIT_DRIVESTATE 1u
#define DATA_OUT_1_0_INIT_MUXSEL 0u
#define DATA_OUT_1_0_INPUT_SYNC 2u
#define DATA_OUT_1_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DATA_OUT_1_0_NUM 0u
#define DATA_OUT_1_0_PORT GPIO_PRT9
#define DATA_OUT_1_0_SLEWRATE CY_GPIO_SLEW_FAST
#define DATA_OUT_1_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define DATA_OUT_1_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define DATA_OUT_1_INBUF_ENABLED 0u
#define DATA_OUT_1_INIT_DRIVESTATE 1u
#define DATA_OUT_1_INIT_MUXSEL 0u
#define DATA_OUT_1_INPUT_SYNC 2u
#define DATA_OUT_1_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DATA_OUT_1_NUM 0u
#define DATA_OUT_1_PORT GPIO_PRT9
#define DATA_OUT_1_SLEWRATE CY_GPIO_SLEW_FAST
#define DATA_OUT_1_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define DATA_OUT_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define DATA_OUT_INBUF_ENABLED 0u
#define DATA_OUT_INIT_DRIVESTATE 1u
#define DATA_OUT_INIT_MUXSEL 0u
#define DATA_OUT_INPUT_SYNC 2u
#define DATA_OUT_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DATA_OUT_NUM 3u
#define DATA_OUT_PORT GPIO_PRT0
#define DATA_OUT_SLEWRATE CY_GPIO_SLEW_FAST
#define DATA_OUT_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
