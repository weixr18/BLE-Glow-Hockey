...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../UART_Nios.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../uart_kernel.sopcinfo
...
# Design Name 
# setting SOPC_NAME is uart_kernel
SOPC_NAME := uart_kernel
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001028
SOPC_SYSID_FLAG += --sidp=0x10001028
ELF_PATCH_FLAG  += --sidp 0x10001028

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1599482139
SOPC_SYSID_FLAG += --timestamp=1599482139
ELF_PATCH_FLAG  += --timestamp 1599482139
