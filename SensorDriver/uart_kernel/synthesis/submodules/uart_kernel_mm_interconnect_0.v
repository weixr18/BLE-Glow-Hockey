// uart_kernel_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module uart_kernel_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> sdram_controller_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // sdram_controller_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> uart_s1_agent:cp_data
	...
	wire  [104:0] sysid_qsys_control_slave_agent_rp_data;                                      // sysid_qsys_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] sdram_controller_s1_agent_rp_data;                                           // sdram_controller_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] uart_s1_agent_rp_data;                                                       // uart_s1_agent:rp_data -> router_006:sink_data
	...
	uart_kernel_mm_interconnect_0_router router (
	...
	uart_kernel_mm_interconnect_0_router_001 router_001 (
	...
	uart_kernel_mm_interconnect_0_router_002 router_002 (
	...
	uart_kernel_mm_interconnect_0_router_002 router_003 (
	...
	uart_kernel_mm_interconnect_0_router_004 router_004 (
	...
	uart_kernel_mm_interconnect_0_router_004 router_005 (
	...
	uart_kernel_mm_interconnect_0_router_002 router_006 (
	...
	uart_kernel_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                      //       clk.clk
		.reset               (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_kernel_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
