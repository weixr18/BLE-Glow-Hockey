...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../FPGA_Data_Hub.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100010a0
SOPC_SYSID_FLAG += --sidp=0x100010a0
ELF_PATCH_FLAG  += --sidp 0x100010a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1599550417
SOPC_SYSID_FLAG += --timestamp=1599550417
ELF_PATCH_FLAG  += --timestamp 1599550417
